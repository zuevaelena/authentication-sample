...
class NewsApiRepository : NewsRepository {
    ...
    private val mockList: List<News> = ArrayList<News>().apply {
        add(News( NewsSource("bbc-news", "BBC News")
                , "Prince Charles won't 'meddle' when he's king"
                , "I'm not that stupid - the Prince of Wales says he'll have to stop campaigning when he's monarch."
                , Date()
                , ""
                , Uri.parse("https://ichef.bbci.co.uk/news/1024/branded_news/A232/production/_104222514_mediaitem104222331.jpg") ))
        ...
        add(News( NewsSource("cnn", "Theatlantic.com")
                ...
                , Date()
                , "Amanda Mull"
                , Uri.parse("https://cdn.theatlantic.com/assets/media/img/mt/2018/11/RTX5U8L5-1/facebook.jpg?1541634926") ))
        add(News( NewsSource("politico", "Politico")
                ...
                , Uri.parse("https://static.politico.com/e6/25/b99f7b214a6d8b68004c1189266a/181107-kevin-mccarthy-gty-773.jpg") ))
        add(News( NewsSource("", "Vox.com")
                , "Early numbers suggest voter turnout soared in the 2018 midterms"
                , "We won’t know the exact figures for a while."
                , Date()
                , "Emily Stewart"
                , Uri.parse("https://cdn.vox-cdn.com/thumbor/8-RkmFvTO5u5iDOB1-POdijV-ZU=/0x350:4928x2930/fit-in/1200x630/cdn.vox-cdn.com/uploads/chorus_asset/file/13402277/1058207668.jpg.jpg") ))

        add(News( NewsSource("", "Welt.de")
                , "Umbau in der Kraftwerksparte belastet Siemens-Geschäft"
                , ""
                , Date()
                , "WELT"
                , Uri.parse("https://www.welt.de/img/newsticker/dpa_nt/infoline_nt/wirtschaft_nt/mobile183475766/2931352957-ci16x9-w1200/urn-newsml-dpa-com-20090101-181108-99-720186-large-4-3-jpg.jpg") ))
    }
